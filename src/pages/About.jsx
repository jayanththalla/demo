...
const AboutSection = () => {
    ...
    return (
        <div className="bg-white text-black pb-16" ref={ref}>
            ...
            <div className="relative px-4 md:px-8 lg:px-16 pt-4 pb-8">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-white to-transparent opacity-60 rounded-lg mx-4 md:mx-8 lg:mx-16"></div>
            </div>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.div
                ...
                initial="hidden"
                animate={controls}
                className="max-w-3xl mx-auto bg-white text-black text-center p-6 md:p-8 rounded-lg border-2 mt-12 md:mt-16"
                style={{ borderColor: '#9f1d21' }}
            >
                <h3 className="text-xl md:text-2xl font-bold" style={{ color: '#9f1d21' }}>About us</h3>
            ...
            <div className="max-w-4xl mx-auto mt-10 px-4 sm:px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    {/* Mission */}
                    <motion.div
                        className="animate-on-scroll border-2 p-6 rounded-lg shadow-md bg-white transform transition-all duration-300 hover:shadow-red-500/30 hover:shadow-lg"
                    ...
                    >
                        <div className="flex items-start mb-4">
                            <Target className="w-6 h-6 mr-2 flex-shrink-0" style={{ color: '#9f1d21' }} />
                            <h3 className="text-xl font-bold" style={{ color: '#9f1d21' }}>
                    ...
                    >
                        <div className="flex items-start justify-end mb-4">
                            <h3 className="text-xl font-bold text-right">
                                <span className="block" style={{ color: '#9f1d21' }}>Our</span> Vision
                            </h3>
                            <Award className="w-6 h-6 ml-2 flex-shrink-0" style={{ color: '#9f1d21' }} />
                        </div>
                        <p className="mt-2 text-sm md:text-base text-gray-700">
            ...
            <div className="relative mt-16">
                <div className="absolute inset-0  z-10 flex items-center justify-center">
                    ...
                    >
                        <p className="text-lg md:text-2xl font-semibold max-w-3xl mx-auto leading-relaxed text-white">
                            <span style={{ color: 'yellow' }}>Join us on this cinematic journey</span>, where every frame tells a story,
            ...
            >
                {[
                    ...
                    <motion.div
                        key={index}
                        variants={fadeIn}
                        whileHover={{ y: -10, boxShadow: "0 10px 25px -5px rgba(159, 29, 33, 0.3)" }}
                        className="bg-white p-6 rounded-lg text-center cursor-pointer transition-all duration-300 border border-gray-200"
                        style={{ borderColor: 'yellow' }}
                    >
                        <div className="text-4xl mb-4">{item.icon}</div>
                        <h3 className="text-lg font-bold mb-2" style={{ color: '#9f1d21' }}>{item.title}</h3>
                        <div className="w-16 h-1 mx-auto my-3" style={{ backgroundColor: 'yellow' }}></div>
