                    ...
                    >
                        ...
                        <ul className="space-y-4">
                            ...
                            <motion.li className="flex items-center" whileHover={{ x: 5 }}>
                                ...
                                <a href="mailto:bingehall08@gmail.com" className="text-inherit hover:underline">
                                    bingehall08@gmail.com
                                </a>
                            </motion.li>
                            ...
                            <motion.li className="flex items-center" whileHover={{ x: 5 }}>
                                ...
                                <a
                                    href="https://www.google.com/maps?q=Binge+Hall,+Laxmi+Heights,+Vasavi+Colony,+Nagole+Road,+near+Ashtalakshmi+Temple,+RK+Puram,+Kothapet,+Hyderabad,+Telangana+500035"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-inherit hover:underline"
                                >
                                    Binge Hall, Laxmi Heights, Vasavi Colony, Nagole Road, near Ashtalakshmi Temple, RK Puram, Kothapet, Hyderabad, Telangana 500035
                                </a>
                            </motion.li>
